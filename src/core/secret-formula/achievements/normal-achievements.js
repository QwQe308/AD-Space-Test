...
export const normalAchievements = [
  ...
  },
  {
    ...
    get reward() {
      return `Start with ${formatInt(1000)} antimatter. (may be reduced due to space)`;
    },
    effect: 1000,
  },
  {
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `Start with ${formatInt(50000)} antimatter.`;
    },
    effect: 50000,
  },
  {
  ...
  },
  {
    ...
    checkRequirement: () =>
      Currency.antimatter.gte(DC.E63) && Currency.antimatter.productionPerSecond.gt(Currency.antimatter.value),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  },
  {
    id: 43,
  ...
  },
  {
    ...
    checkRequirement: () =>
      AchievementTimers.marathon1.check(Currency.antimatter.productionPerSecond.gt(Currency.antimatter.value), 30),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  },
  {
    id: 45,
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `Increase the multiplier for buying ${formatInt(10)} Antimatter Dimensions by +${formatPercents(
        new Decimal(0.01)
      )}.`;
    },
    effect: 1.01,
  ...
  },
  {
    ...
    effect: () =>
      (Player.isInAnyChallenge ? Decimal.max(new Decimal(4).div(Time.thisInfinity.totalMinutes.add(1)), 1) : 1),
  ...
  },
  {
    ...
    get description() {
      return `Play for ${formatInt(8)} Hours.`;
    },
  ...
  {
    id: 115,
    name: "I wish I had gotten 8 eternities",
  ...
  },
  {
    ...
    checkEvent: GAME_EVENT.DIMBOOST_AFTER,
    get reward() {
      return `The multiplier from Dimension Boosts to Antimatter Dimensions is ${formatPercents(
        new Decimal(0.01)
      )} higher.`;
    },
    effect: 1.01,
  ...
  },
  {
    ...
    name: "Popular music",
    get description() {
      return `Have more Replicanti than 1.80e308.`;
    },
  ...
  },
  {
    ...
    checkRequirement: () =>
      Currency.antimatter.gte("1e26000") && Time.thisEternity.totalMinutes.lte(1) && player.dilation.active,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
  ...
  },
  {
    ...
    checkRequirement: () => GlyphInfo.basicGlyphTypes.every(type => Glyphs.activeList.some(g => g.type === type)),
    checkEvent: GAME_EVENT.REALITY_RESET_BEFORE,
  ...
  },
  {
    ...
    checkRequirement: () =>
      Glyphs.activeList
        ...
        .map(glyph => glyph.effects.length)
        .max()
        .gte(4),
    checkEvent: GAME_EVENT.GLYPHS_CHANGED,
  },
  ...
  },
  {
    ...
    checkRequirement: () =>
      EternityChallenges.all
        .map(ec => ec.completions)
        .min()
        .gte(5) && Time.thisReality.totalSeconds.lte(1),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  },
  {
    id: 164,
