  ...
  },
  {
    ...
    subtabs: [
      ...
      },
      {
        key: "past",
        name: "Past",
        symbol: "<i class='fas fa-step-backward'></i>",
        component: "PastEmpowerTab",
        condition: () => AbyssResearches.PST.completed,
        id: 3,
        hidable: true,
      },
      {
        ...
        condition: () => AbyssResearches.PRS.completed,
        id: 4,
        hidable: true,
      },
      {
        key: "future",
        name: "Future",
        symbol: "<i class='fas fa-step-forward'></i>",
        component: "FutureEmpowerTab",
        condition: () => AbyssResearches.FTR.completed,
        id: 5,
        hidable: true,
      },
      {
