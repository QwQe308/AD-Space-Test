...
const passiveIPMult = () => {
  ...
  const normalValue = Perk.studyPassive.isBought ? 1e50 : 1e40;
...
export const normalTimeStudies = [
  ...
  },
  {
    ...
    description: () =>
      ...
      and all Replicanti related IP cost /${formatInt(1e40)}`,
    effect: 1e40,
  },
  {
    id: 31,
    ...
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () =>
      `Powers up multipliers that are based on your Infinities 
      (Bonuses${formatPow(2)}) (also called ISU Power)`,
    effect: 2,
  },
  {
    id: 32,
  ...
  },
  {
    ...
    requirement: [22],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: "You keep your Replicanti Galaxies on Infinity",
  },
  {
    id: 34,
    cost: DC.D6,
    requirement: [21],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: "Replicanti can go beyond 1.80e308, but growth rapidly slows down at higher amounts.",
  },
  {
    id: 41,
    cost: DC.D4,
  ...
  },
  {
    ...
    requirement: [41, 42],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `You gain ${formatX(1e20)} more Infinity Points`,
    effect: 1e20,
  },
  {
    id: 52,
  ...
  },
  {
    ...
    requirement: [151],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `${formatX(DC.E924)} multiplier on all Antimatter Dimensions`,
    effect: () => DC.E924,
  },
  {
    id: 162,
    ...
    requirement: [151],
    reqType: TS_REQUIREMENT_TYPE.AT_LEAST_ONE,
    description: () => `${formatX(1e12)} multiplier on all Infinity Dimensions`,
    effect: 1e12,
  },
  {
    id: 171,
  ...
  },
  {
    ...
    effect: () => {
      ...
      const firstPart = totalBoost.pow(10).clampMaxExponent(100000);
      const secondPart = totalBoost.pow(0.75);
