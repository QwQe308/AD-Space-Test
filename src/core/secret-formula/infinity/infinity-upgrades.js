...
export const infinityUpgrades = {
  totalTimeMult: {
    ...
    effect: () => Decimal.pow(Time.totalTimePlayed.totalMinutes, 0.15),
  ...
  thisInfinityTimeMult: {
    ...
    effect: () => Decimal.max(Decimal.pow(Time.thisInfinity.totalMinutes.add(1), 0.5), 1),
    formatEffect: value => formatX(value, 2, 2),
    charged: {
      description:
  ...
  ipOffline: {
    id: "ipOffline",
    cost: 1000,
    checkRequirement: () => PlayerProgress.imaginaryUnlocked() || Achievement(41).isUnlocked,
