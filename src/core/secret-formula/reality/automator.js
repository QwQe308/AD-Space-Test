...
export const automator = {
  categoryNames: ["Time Studies", "Event Triggers", "Alter Settings", "Information", "Script Flow", "Mod related"],
  commands: [
    {
      id: 0,
      isUnlocked: () => true,
    ...
    },
    {
      ...
      description: "Unlocks the specified Stuffs.",
      sections: [
        {
          name: "MODIFIERS",
          items: [
    ...
    },
    {
      ...
      syntax: `
        ...
        *<b>start</b> ic<u>N</u><br>
        <b>start</b> dilation`,
      description: `Start a specified Infinity Challenge, Eternity Challenge or a Dilated Eternity. This command will also attempt
      ...
      examples: ["start ec12", "start ic2", "start dilation"],
    },
    {
      id: 6,
      isUnlocked: () => true,
    ...
    },
    {
      ...
      description: () => {
        ...
        return `This is a list of "currencies" or numbers that you can use within the Automator.<br>
          ...
          ${PlayerProgress.realityUnlocked() ? "<b>rm</b> - Current Reality Machine amount  <br>" : ""}
          ...
          ${PlayerProgress.realityUnlocked() ? "<b>realities</b> - Current Reality amount <br>" : ""}
  ...
  PlayerProgress.realityUnlocked() || PlayerProgress.dilationUnlocked()
    ...
    },
    {
      ...
      keyword: "MIRROR",
      category: 5,
      syntax: `<b>Mirror</b> set <u>R,G,B</u><br>
      <b>Mirror</b> enter<br>
      <b>Mirror</b> escape`,
      description: `Do some Mirror related things.`,
      sections: [
        {
          name: "SETTINGS",
          items: [
      ...
      examples: ["Mirror set 15,20,20", "Mirror enter", "Mirror escape"],
    },
    {
      id: 21,
      isUnlocked: () => true,
      keyword: "BUY",
      category: 5,
      syntax: `<b>Buy</b> <u>Items</u>`,
      description: () =>
        `Buying something that autobuyers may buy. This may be useful if autobuyers aren't unlocked yet or they are way too slow.<br>
      ...
      `,
      examples: ["Buy Infinity Dimensions", "Buy Infinity Upgrades", "Buy Break Infinity Upgrades"],
    },
  ],
  otherAutomatorPoints: [
    {
      ...
      automatorPoints: () =>
        2 *
        Decimal.clampMax(Currency.realities.value, 50).mantissa *
