...
export class EternityAutobuyerState extends AutobuyerState {
  ...
  get hasAdditionalModes() {
    return RealityUpgrade(13).isBought || AbyssResearches["Present-Future"].isEffectActive;
  }
  ...
  get willEternity() {
    if (EternityChallenges.isRunning) {
      ...
      return !EternityChallenges.current?.gainedCompletionStatus.hasMoreCompletions;
    }
